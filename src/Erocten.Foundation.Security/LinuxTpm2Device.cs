...
namespace PowerEasy.Foundation.Security
{
    ...
    public sealed class LinuxTpm2Device : Tpm2Device
    {
        ...
        public LinuxTpm2Device(string tpmDevicePath = null)
        {
            ...
            {
                Console.WriteLine("Failed to connect to " + tpmDevicePath + ":" + e);
                ...
                {
                    Console.WriteLine($"Exception while loading tpm2-abrmd: {ee}");
                }
                ...
                if (TctiCtx == null)
                {
                    ...
                    catch (Exception)
                    {
                        ...
                        TrmDevice = new TcpTpmDevice("127.0.0.1", 2321, false, true);
                        TrmDevice.Connect();
                    }
                }
            }
